...
var help = {
	dashboard: 'abrir o dashboard no brownser',
	bosBackend: 'bosBackendServer',
...
function buildReplClient(bosBackend) {
	var client = internalClient.build(bosBackend, { isRoot: true });
